...
ActiveRecord::Schema[7.0].define(version: 2022_10_12_205015) do
  ...
  create_table "statitics", force: :cascade do |t|
    t.string "token"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_statitics_on_user_id"
  end
  ...
  add_foreign_key "statitics", "users"
end
